...
const contactInfo = [
  ...
  },
  {
    ...
    label: "Address",
    value: "VisionX, 12.9330376, 77.560489",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <GlassmorphicCard className="p-0 overflow-hidden">
              <div className="h-[300px] w-full relative bg-gradient-to-br from-stalight-primary/20 to-stalight-blue/20 flex items-center justify-center">
                <img 
                  src="/placeholder.svg"
                  alt="Map location"
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <p className="text-white/80">Interactive map will be rendered here</p>
                </div>
              </div>
            </GlassmorphicCard>
          </div>
